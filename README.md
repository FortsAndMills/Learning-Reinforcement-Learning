...
* **23/09/18** Added detailed review of basic policy gradient algorithms: baselines for REINFORCE, Advantage Actor-Critic. Minor updates on rubik's cube solution attempts.
